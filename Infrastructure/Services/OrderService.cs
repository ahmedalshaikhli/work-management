...
namespace Infrastructure.Services
{
   ...
   public async Task<Order> CreateOrderAsync(string buyerEmail, int deliveryMethodId, string basketId, Address shippingAddress, string paymentMethod )
{
    ...
    else
    {
        ...
        {
            order = new Order(items, buyerEmail, shippingAddress, deliveryMethod, subtotal, paymentMethod);
        }
        else
        {
            order = new Order(items, buyerEmail, shippingAddress, deliveryMethod, subtotal, paymentMethod, basket.PaymentIntentId);
        }
